...
VERILOG_TESTS = [
    ...
    {
        "name": "uart_frame_buffer_backend",
        "sources": [
            "rtl/uart/uart_frame_packet_tx.v",
    ...
    {
        "name": "cpu_owned_uart_frame_flow",
        "sources": [
            "rtl/uart/uart_frame_packet_tx.v",
            "rtl/uart/uart_frame_buffer_backend.v",
    ...
    },
    {
        ...
        "sources": [
            ...
            "tb/uart_cpu_fft_console_cmd_tb.v",
        ],
    },
    {
        "name": "uart_cpu_fft_console_e2e",
        "sources": [
            "rtl/uart/uart_rx.v",
            "rtl/uart/uart_tx.v",
            "rtl/cpu/mini_cpu_program_rom.v",
            ...
            "rtl/cpu/mini_cpu_fft_system.v",
            "rtl/uart/uart_cpu_fft_console.v",
            "tb/uart_cpu_fft_console_e2e_tb.v",
        ],
    },
    {
        "name": "tang_uart_cpu_fft_console_top",
        "sources": [
            "rtl/uart/uart_rx.v",
            "rtl/uart/uart_tx.v",
            "rtl/cpu/mini_cpu_program_rom.v",
    ...
    {
        "name": "tang_cpu_owned_frame_uart_top",
        "sources": [
            "rtl/uart/uart_rx.v",
            "rtl/uart/uart_tx.v",
            "rtl/uart/uart_frame_packet_rx.v",
    ...
    },
    {
        ...
        "sources": [
            ...
            "rtl/control/fft_accelerator_mmio.v",
            "rtl/cpu/mini_cpu_fft_system.v",
            "tb/mini_cpu_fft_bus_decode_tb.v",
        ],
    },
    {
        "name": "mini_cpu_fft_register_write",
        "sources": [
            "rtl/cpu/mini_cpu_program_rom.v",
            "rtl/cpu/mini_cpu_core.v",
            "rtl/control/fft_mmio_regs.v",
            ...
            "rtl/control/fft_accelerator_mmio.v",
            "rtl/cpu/mini_cpu_fft_system.v",
            "tb/mini_cpu_fft_register_write_tb.v",
        ],
    },
    {
        "name": "mini_cpu_fft_start_done",
        "sources": [
            "rtl/cpu/mini_cpu_program_rom.v",
            "rtl/cpu/mini_cpu_core.v",
            "rtl/control/fft_mmio_regs.v",
            ...
            "rtl/control/fft_accelerator_mmio.v",
            "rtl/cpu/mini_cpu_fft_system.v",
            "tb/mini_cpu_fft_start_done_tb.v",
        ],
    },
    {
        "name": "mini_cpu_fft_impulse_program",
        "sources": [
            "rtl/cpu/mini_cpu_program_rom.v",
            "rtl/cpu/mini_cpu_core.v",
            "rtl/control/fft_mmio_regs.v",
            ...
            "rtl/control/fft_accelerator_mmio.v",
            "rtl/cpu/mini_cpu_fft_system.v",
            "tb/mini_cpu_fft_impulse_program_tb.v",
        ],
    },
    {
    ...
    {
        "name": "fft_accelerator_mmio_control",
        "sources": [
            "rtl/control/fft_mmio_regs.v",
            "rtl/dsp/sample_block_buffer.v",
            "rtl/dsp/spectral_gain_select.v",
