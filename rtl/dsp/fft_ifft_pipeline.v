module fft_ifft_pipeline #(
    ...
    reg signed [SAMPLE_WIDTH-1:0] fft_real_in;
    reg signed [SAMPLE_WIDTH-1:0] fft_imag_in;

    wire fft_out_valid;
    wire [INDEX_WIDTH-1:0] fft_out_index;
    wire signed [SAMPLE_WIDTH-1:0] fft_real_out;
    wire signed [SAMPLE_WIDTH-1:0] fft_imag_out;
    wire fft_busy;
    wire fft_done;

    wire spectral_out_valid;
    wire signed [SAMPLE_WIDTH-1:0] spectral_real_out;
    wire signed [SAMPLE_WIDTH-1:0] spectral_imag_out;
    ...
    wire signed [SAMPLE_WIDTH-1:0] ifft_real_out;
    wire signed [SAMPLE_WIDTH-1:0] ifft_imag_out;
    wire ifft_busy;
    wire ifft_done;
    ...
    assign sample_out = ifft_real_out;
    ...
    always @(posedge clk) begin
        if (rst) begin
            ...
            fft_real_in    <= {SAMPLE_WIDTH{1'b0}};
            fft_imag_in    <= {SAMPLE_WIDTH{1'b0}};
            ...
            fft_real_in  <= buffer_frame_sample;
            fft_imag_in  <= {SAMPLE_WIDTH{1'b0}};
